...
cur = con.cursor()
theory = {'logarithms': {'definition': (open('DATA/logarithms/definition.txt', encoding='UTF-8').read(),
                              open('DATA/logarithms/log.png', 'rb')),
                         'equations': (open('DATA/logarithms/equations.txt', encoding='UTF-8').read(),
                              open('DATA/logarithms/logarithming.jpg', 'rb')),
                         'properties': (open('DATA/logarithms/properties.txt', encoding='UTF-8').read(),
                              open('DATA/logarithms/properties.jpg', 'rb'))},
          'exponents': {'definition': (open('DATA/exponents/definition.txt', encoding='UTF-8').read(),
                             open('DATA/exponents/def.jpg', 'rb')),
                        'differentiating': open('DATA/exponents/differentiating.txt', encoding='UTF-8').read(),
                        'properties': (open('DATA/exponents/properties.txt', encoding='UTF-8').read(), '')},
          'derivatives': {'derivative': (open('DATA/derivatives/derivative.txt', encoding='UTF-8').read(),
                          ...
                          'integral': [InputMediaPhoto(open('DATA/derivatives/integral.png', 'rb'),
                           ...
                           'formulas': (open('DATA/derivatives/formulas.txt', encoding='UTF-8').read(),
                               open('DATA/derivatives/formulas.png', 'rb')),
                          'min_max': open('DATA/derivatives/min_max.txt', encoding='UTF-8').read()},
          'probability': {'definition': (open('DATA/probability/definition.txt', encoding='UTF-8').read(), ''),
                          'complex_prob': open('DATA/probability/complex.txt', encoding='UTF-8').read(),
                          ...
                          'games': open('DATA/probability/game.txt', encoding='UTF-8').read(),
                          'lines': open('DATA/probability/lines.txt', encoding='UTF-8').read(),
                          'production': open('DATA/probability/production.txt', encoding='UTF-8').read(),
                          'shooter': open('DATA/probability/shooter.txt', encoding='UTF-8').read()},
          'trigonometry': {'definition': (open('DATA/trigonometry/definition.txt', encoding='UTF-8').read(),
                           ...
                           'equations': (open('DATA/trigonometry/equations.txt', encoding='UTF-8').read(),
                                         open('DATA/trigonometry/table.jpg', 'rb')),
                           'formulas': (open('DATA/trigonometry/formulas.txt', encoding='UTF-8').read(),
                               open('DATA/trigonometry/r_formulas.jpg', 'rb'))},
          'stereometry': {'definition': (open('DATA/stereometry/definition.txt', encoding='UTF-8').read(),
                          ...
                          'plain': [InputMediaPhoto(open('DATA/stereometry/plain_0.png', 'rb'),
                                                       caption=open('DATA/stereometry/plain.txt',
                                                                    encoding='UTF-8').read())] +
                                [InputMediaPhoto(open(f'DATA/stereometry/plain_{i}.png', 'rb').read())
                                 for i in range(1, 6)],
                          ...
                          'complex': [open('DATA/stereometry/complex.txt',encoding='UTF-8').read(),
                          ...
                          'sdl': [open('DATA/stereometry/sdl.txt', encoding='UTF-8').read(),
                          ...
                          'facts': [open('DATA/stereometry/facts.txt', encoding='UTF-8').read()] +
                                [InputMediaPhoto(open(f'DATA/stereometry/fact_{i}.png', 'rb')) for i in range(5)],
                          'ttask': (open('DATA/stereometry/ttask.txt', encoding='UTF-8').read(),
